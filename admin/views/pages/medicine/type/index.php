...
<div class="mb-3 text-end">
    <a href="<?= $base_url ?>/type/create" class="btn btn-primary">
        Add Medicine Type
    </a>
</div>
    ...
    <table
        ...
        <thead class="table-dark text-center">
            <tr>
                ...
                <th data-field="type_name" data-sortable="true">Type Name</th>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <div class="btn-group btn-group-sm">
                            ...
                            <a href="<?= $base_url ?>/type/edit/<?= $value->id ?>"
                                class="btn btn-primary">
                                Edit
                            </a>

                            <a href="<?= $base_url ?>/type/delete/<?= $value->id ?>"
